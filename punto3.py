...
class DoublyLinkedList:
    ...
    def reverse(self):
        ...
        while current_nodo is not None:
            next_temp = current_nodo.next
            current_nodo.next = prev_temp
            current_nodo.prev = next_temp

            prev_temp = current_nodo
            current_nodo= next_temp

        self.head = prev_temp


customdll1 = DoublyLinkedList()
customdll1.generate(6,1,99)
print(customdll1)
customdll1.reverse()
print(customdll1)
